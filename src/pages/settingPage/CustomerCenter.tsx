    ...
    <Container>
      ...
      <div>
        ...
        <ContentWrap istoggle={openIndex === 0}>
          ...
          <br />
          프로필 사진을 기본 이미지로 변경하고 싶다면, 아래 경로를 추가로 진행해
          주세요.
          <CaptionMdiv>
      ...
      <div>
        ...
        <ContentWrap istoggle={openIndex === 3}>
          ...
          <br />
          - 서로 간의 친구 관계가 끊어집니다.
          <br />- 차단 당한 사용자는 차단한 사용자의 아이디를 검색해도 검색되지
          않습니다.
        </ContentWrap>
      </div>
      ...
      <div>
        ...
        <ContentWrap istoggle={openIndex === 5}>
          ...
          <CaptionMdiv>경로: 하단 ‘마이’ → 이름 하단 ‘지난 투데이’</CaptionMdiv>
          <br />
          친구가 이전에 답변한 투데이 질문을 확인하고 싶다면, 아래 경로로 진행해
          주세요.
          <CaptionMdiv>
            경로: 하단 ‘프렌즈’ → 답변을 확인하고 싶은 사용자 선택 → 해당 사용자
            프로필로 이동 → 사용자 이름 하단 ‘지난 투데이’
          </CaptionMdiv>
        </ContentWrap>
      </div>
      ...
      <div>
        ...
        <ContentWrap istoggle={openIndex === 6}>
          ...
          <br />
          투데이 질문에 대한 답변을 삭제하고 싶다면 @티피프렌즈 로 문의해주세요.
        </ContentWrap>
      </div>
