import { TagValueKey, UserInfo, UserInfoToken, UserTag } from "@libs/types/UserTypes";
...
export const UserApi = {
    ...
    GET_FILTERED_USER_TAG: async (userId: number, largeCategory: TagValueKey): Promise<any> => {
